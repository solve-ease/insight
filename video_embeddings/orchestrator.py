...
def process_single_video(video_path, frames, embedder, vector_db):
    ...
    try:
        ...
        vector_db.write_embeddings(pooled_embeddings, metadata_list)
        
        logger.info(f"Successfully indexed video: {video_path}")
...
def index_videos(folder_path: str, qdrant_host: str = "localhost", 
                ...
                embedder: VideoFrameEmbedder = None):
    """
    ...
    Args:
        ...
        embedder: Optional VideoFrameEmbedder instance (reuses shared model if provided)
    """
    try:
